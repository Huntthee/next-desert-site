  ...
  return (
    <>
      ...
      <article className="bg-lorange p-2 mx-1 rounded lg:mx-7 xl:mx-9 xl:mt-7">
        ...
        <img
          src="images/reactive_images.webp"
          alt="For PNGTubers! Set up these reactive images to respond to your voice input."
        ...
        <figure className="my-4 px-1">
          <ul>
            <li className="font-bold">Reactive Images for PNGTubers!</li>
            <li>4 Images for $60</li>
      ...
      <article className="bg-salmon p-2 mx-1 rounded lg:mx-7 xl:mx-9 xl:mb-8">
        ...
        <img
          ...
          className="m-auto px-4 py-4 xl:px-8 xl:py-4 "
        />
        <h3 className="mb-2 xl:text-lg font-bold">$60</h3>
        <hr />
        <figure className="my-4 px-1">
          <ul>
