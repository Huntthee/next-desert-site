  ...
  return (
    <>
      <section className="text-center px-3">
        ...
        <p>Supporting me here will allow me to continue pursuing my dreams creating content working from home, I love you, and your support is appreciated more than you know.</p>
        <a href="https://www.paypal.com/paypalme/desertwhale" id="donation-link" target="_blank" rel="noreferrer">Donate!</a>
      </section>
    </>
  ) 
}